...
**Descriptions of data extracted in each column of the spreadsheet entitled "scopingreview_dataextractions_final.xlsx":**
...
**attenuated_nonpathogenic_strains:** For studies that reported using attenuated or non-pathogenic strains, the attenuated or non-pathogenic strains used are provided in this column. 
  * If a given study did report using attenuated or non-pathogenic strains in population dynamics experiments, but the strains used were not provided for a given bacterial type (i.e., E. coli, Listeria spp., Salmonella spp.) then this information was reported as “(Specific bacterial type): no strain information provided.”
